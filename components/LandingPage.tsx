               ...
               <div className="relative p-6 md:p-12 rounded-[3rem] bg-zinc-950 border border-white/5 shadow-2xl space-y-12">
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 xs:grid-cols-2 gap-4 md:gap-6">
                       <div className="p-5 md:p-6 rounded-2xl bg-zinc-900/50 border border-white/5 space-y-4">
                          <p className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest border-b border-white/5 pb-2 text-center md:text-left">Old Way</p>
                          <div className="space-y-4">
                             <div className="flex items-center justify-between text-[11px] gap-2">
                                <span className="text-zinc-600 w-20 shrink-0">Registry</span>
                                <span className="text-red-400 font-bold font-mono text-right flex-1">30 Days</span>
                             </div>
                             <div className="flex items-center justify-between text-[11px] gap-2">
                                <span className="text-zinc-600 w-20 shrink-0">Legal Fees</span>
                                <span className="text-red-400 font-bold font-mono text-right flex-1">$2,500+</span>
                             </div>
                             <div className="flex items-center justify-between text-[11px] gap-2">
                                <span className="text-zinc-600 w-20 shrink-0">Payouts</span>
                                <span className="text-red-400 font-bold font-mono text-right flex-1">3-5 Days</span>
                             </div>
                          </div>
                       </div>
                       <div className="p-5 md:p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 space-y-4 shadow-[0_0_20px_rgba(16,185,129,0.05)]">
                          <p className="text-[9px] font-bold text-emerald-400 uppercase tracking-widest border-b border-emerald-500/20 pb-2 text-center md:text-left">Venyro Way</p>
                          <div className="space-y-4">
                             <div className="flex items-center justify-between text-[11px] gap-2">
                                <span className="text-emerald-900/80 w-20 shrink-0">Protocol</span>
                                <span className="text-emerald-400 font-bold font-mono text-right flex-1">2 Mins</span>
                             </div>
                             <div className="flex items-center justify-between text-[11px] gap-2">
                                <span className="text-emerald-900/80 w-20 shrink-0">Fees</span>
                                <span className="text-emerald-400 font-bold font-mono text-right flex-1">&lt; $0.50</span>
                             </div>
                             <div className="flex items-center justify-between text-[11px] gap-2">
                                <span className="text-emerald-900/80 w-20 shrink-0">Settle</span>
                                <span className="text-emerald-400 font-bold font-mono text-right flex-1">Instant</span>
                             </div>
                          </div>
                       </div>
                    </div>
                  ...
                  <div className="p-6 bg-zinc-900/30 rounded-2xl border border-white/5 flex items-center justify-between">
                     <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Efficiency Gain</span>
                     </div>
                     <span className="text-2xl font-bold text-primary font-mono tracking-tighter">94.2%</span>
                  </div>
               </div>
            </div>
          </div>
