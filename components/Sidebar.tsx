        ...
        <div className="flex flex-col h-full overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-1">
            ...
            <div className="space-y-1 mb-6">
               <button 
                disabled
                className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl border border-border/30 bg-surface/10 text-zinc-600 cursor-not-allowed group"
              >
              ...
              <div className="px-3 pb-1">
                 <span className="text-[8px] uppercase font-bold text-zinc-700 tracking-[0.2em] ml-7">Coming Soon</span>
              </div>
