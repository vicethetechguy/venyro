      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header className="h-16 shrink-0 border-b border-border flex items-center justify-between px-4 md:px-8 bg-background/80 backdrop-blur-md z-[100] print:hidden shadow-lg sticky top-0">
          <div className="flex items-center gap-2 md:gap-4 overflow-hidden">
            <button 
              ...
              className="md:hidden p-1.5 hover:bg-surface/50 rounded-lg transition-colors flex items-center justify-center shrink-0"
            >
        ...
        <div className="flex-1 overflow-y-auto relative z-10 p-4 md:p-8 lg:p-12 print:p-0">
          ...
          {activeTab === 'generation' && (
            <div className="max-w-4xl mx-auto space-y-12 md:space-y-16 overflow-x-hidden">
              {step === 'INITIAL' && (
                <div className="space-y-10 md:space-y-16 animate-in fade-in slide-in-from-bottom-4 py-4 md:py-10">
                  <div className="text-center space-y-4">
                    <h1 className="text-3xl md:text-5xl font-medium text-primary tracking-tight">Initiate Synthesis</h1>
                    <p className="text-zinc-500 font-light text-xs md:text-base">Define your venture's core identity and visual direction.</p>
                  </div>
                    ...
                    <div className="space-y-3 md:space-y-4">
                      ...
                      <div className="relative group">
                        <input 
                          ...
                          className="w-full bg-surface/30 border border-border rounded-xl md:rounded-2xl px-4 py-3 md:px-5 md:py-4 text-base md:text-xl text-primary placeholder:text-zinc-700 focus:outline-none focus:border-zinc-500 transition-all shadow-xl"
                  ...
                  <div className="space-y-4 md:space-y-6 pt-2 md:pt-6">
                    ...
                    <div className="relative group">
                      <textarea 
                        ...
                        className="w-full bg-surface/30 border border-border rounded-2xl md:rounded-[2rem] p-5 md:p-8 text-sm md:text-xl text-primary placeholder:text-zinc-700 focus:outline-none focus:border-zinc-500 transition-all min-h-[140px] md:min-h-[180px] resize-none leading-relaxed shadow-2xl"
